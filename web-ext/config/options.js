browser.storage.local.get('config').then(data => {
    ...
    if (config) {
        ...
        document.getElementById("ClickAttemtpMonitor").checked = config.ClickAttemtpMonitor;
        document.getElementById("UrlsVisitedMonitor").checked = config.UrlsVisitedMonitor;
    };
});
...
var saveConfiguration = function() {
    ...
    config.ClickAttemtpMonitor = document.getElementById("ClickAttemtpMonitor").checked;
    config.UrlsVisitedMonitor = document.getElementById("UrlsVisitedMonitor").checked;
